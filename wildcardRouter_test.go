...
func init() {
	...
	wcRouter := wildcardRouter.New()
	wcRouter.MountTo("/", mux)
	wcRouter.AddHandler(router)
	wcRouter.AddHandler(ModuleBeforeA{})
	wcRouter.AddHandler(ModuleA{})
	wcRouter.AddHandler(ModuleB{})
}
